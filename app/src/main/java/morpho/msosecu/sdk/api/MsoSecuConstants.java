...
public interface MsoSecuConstants {
    ...
    public static final int AES128_BLOCK_LENGTH = MsoSecuJNI.AES128_BLOCK_LENGTH_get();
    public static final int AES256_BLOCK_LENGTH = MsoSecuJNI.AES256_BLOCK_LENGTH_get();
    public static final int IV_TAG_BLOCK_LENGTH = MsoSecuJNI.IV_TAG_BLOCK_LENGTH_get();
    public static final int SHA256_BLOCK_LENGTH = MsoSecuJNI.SHA256_BLOCK_LENGTH_get();
    public static final int AES_256_GCM_IV_LENGTH = MsoSecuJNI.AES_256_GCM_IV_LENGTH_get();
    public static final int AES_256_GCM_TAG_LENGTH = MsoSecuJNI.AES_256_GCM_TAG_LENGTH_get();
    public static final int AES_256_GCM_KEY_LENGTH = MsoSecuJNI.AES_256_GCM_KEY_LENGTH_get();
    public static final int ALGO_MAX_KEY_LENGTH = MsoSecuJNI.ALGO_MAX_KEY_LENGTH_get();
    ...
    public static final int MSOSECU_SHA256_INIT_ERR = MsoSecuJNI.MSOSECU_SHA256_INIT_ERR_get();
    public static final int MSOSECU_SHA256_UPDATE_ERR = MsoSecuJNI.MSOSECU_SHA256_UPDATE_ERR_get();
    public static final int MSOSECU_SHA256_FINAL_ERR = MsoSecuJNI.MSOSECU_SHA256_FINAL_ERR_get();
    ...
    public static final int MSOSECU_AES128_INIT_ERR = MsoSecuJNI.MSOSECU_AES128_INIT_ERR_get();
    public static final int MSOSECU_AES128_UPDATE_ERR = MsoSecuJNI.MSOSECU_AES128_UPDATE_ERR_get();
    public static final int MSOSECU_AES128_FINAL_ERR = MsoSecuJNI.MSOSECU_AES128_FINAL_ERR_get();
    public static final int MSOSECU_AES_INIT_ERR = MsoSecuJNI.MSOSECU_AES_INIT_ERR_get();
    public static final int MSOSECU_AES_UPDATE_ERR = MsoSecuJNI.MSOSECU_AES_UPDATE_ERR_get();
    public static final int MSOSECU_AES_FINAL_ERR = MsoSecuJNI.MSOSECU_AES_FINAL_ERR_get();
    public static final int MSOSECU_CERT_NOT_SUPPORTED = MsoSecuJNI.MSOSECU_CERT_NOT_SUPPORTED_get();
    public static final int MSOSECU_CA_ALREADY_EXISTS = MsoSecuJNI.MSOSECU_CA_ALREADY_EXISTS_get();
    public static final int MSOSECU_SSL_PATH_ERROR = MsoSecuJNI.MSOSECU_SSL_PATH_ERROR_get();
    public static final int MSOSECU_ASSIGN_RSA_ERR = MsoSecuJNI.MSOSECU_ASSIGN_RSA_ERR_get();
    public static final int MSOSECU_SET_PUBKEY_ERR = MsoSecuJNI.MSOSECU_SET_PUBKEY_ERR_get();
    public static final int MSOSECU_SIGN_REQ_ERR = MsoSecuJNI.MSOSECU_SIGN_REQ_ERR_get();
    public static final int MSOSECU_PARSE_CSR_ERR = MsoSecuJNI.MSOSECU_PARSE_CSR_ERR_get();
}
