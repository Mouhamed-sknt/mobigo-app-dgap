...
public class MorphoImage {
    ...
    public static MorphoImage getMorphoImageFromLive(byte[] imageStructure) {
        ...
        ByteBuffer buffer2 = ByteBuffer.wrap(imageStructure, 4, 2);
        buffer2.order(ByteOrder.LITTLE_ENDIAN);
        int nbColumn = buffer2.getShort();
        ByteBuffer buffer3 = ByteBuffer.wrap(imageStructure, 6, 2);
        buffer3.order(ByteOrder.LITTLE_ENDIAN);
        int resX = buffer3.getShort();
        ByteBuffer buffer4 = ByteBuffer.wrap(imageStructure, 8, 2);
        buffer4.order(ByteOrder.LITTLE_ENDIAN);
        int resY = buffer4.getShort();
