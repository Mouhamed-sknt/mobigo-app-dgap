...
public class ErrorCodes {
    ...
    public static final int MORPHOERR_PATH_ALREADY_INTILIZED = -1300;
    public static final int MORPHOERR_PATH_NOT_EXISTS = -1290;
    ...
    public static String getError(int codeError, int internalError) {
        switch (codeError) {
            case MORPHOERR_PATH_ALREADY_INTILIZED /* -1300 */:
                return "Path is already initialized";
            case MORPHOERR_PATH_NOT_EXISTS /* -1290 */:
                return "Given path does not exists";
            case MORPHOERR_FIRMWARE_NOT_SUPPORTING_SHA256 /* -127 */:
                return "Firmware not supporting SHA256 as signing algo, \n Please update the firmware.";
            case MORPHOERR_FFD_MODULE_NOT_FOUND /* -126 */:
                return "FFD Module Not Present.";
            ...
            case 0:
                return "No error.";
            default:
                return String.format("Unknown error %d, Internal Error = %d", Integer.valueOf(codeError), Integer.valueOf(internalError));
        }
    }

    public static Boolean IntegrerInitializationValueOf(CustomInteger integer) {
        return false;
    }

    public static Boolean LongInitializationValueOf(CustomLong longValue) {
        return false;
    }
}
