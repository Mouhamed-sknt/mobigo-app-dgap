...
public enum TemplateType implements ITemplateType {
    ...
    public static TemplateType[] valuesCustom() {
        TemplateType[] templateTypeArrValuesCustom = values();
        int length = templateTypeArrValuesCustom.length;
        TemplateType[] templateTypeArr = new TemplateType[length];
        System.arraycopy(templateTypeArrValuesCustom, 0, templateTypeArr, 0, length);
    ...
    TemplateType(int code, String label, String extension) {
        this.code = code;
        this.label = label;
    ...
    public static TemplateType getValue(int id) {
        TemplateType[] templateTypes = valuesCustom();
